                ...
                party_confirmed_or_not().then(function(confirmation){
                    ...
                    function generate_qrcode(){
                        return new Promise(function(resolve, reject){
                            ...
                            QRcode.toDataURL(qrcode_venue_information.server + qrcode_venue_information.employeeNumber, function(err, url){
                                if(err){return reject(err)};
                                ...
                                let img_render_html = img.src;

                                resolve(img_render_html);
